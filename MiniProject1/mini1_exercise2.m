%% Solve Van Der Pol using Implicit Euler Fixed Tme Step
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
mu = 3;
tspan = [ta tb];
[T,X] = ImplicitEuler(@VanDerPolJac,tspan,N,x0,mu);
...
%% Solve Van Der Pol using Implicit Euler Adaptive Time Step
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
reltol = 10^(-3);
mu = 10;
[T_A,X_A] = ImplicitEulerAdaptive(@VanDerPolJac,tspan,x0,h0,abstol,reltol,mu);
...
%% Solve prey predator using Implicit Euler Fixed Tme Step
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
clear variables;close all;clc
...
p = [a b];
tspan = [ta tb];
[T,X] = ImplicitEuler(@preyPredator,tspan,N,x0,p);
...
b = 1;
p = [a b];
[T_A,X_A] = ImplicitEulerAdaptive(@preyPredator,tspan,x0,h0,abstol,reltol,p);
